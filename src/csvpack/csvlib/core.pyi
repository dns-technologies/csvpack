...
class CsvReaderIterator:
    """High-performance CSV reader iterator.
    Implements Python iterator protocol. Yields rows as tuples.
    """
...
class CsvWriterIterator:
    """High-performance CSV writer iterator.
    Implements Python iterator protocol. Yields bytes chunks.
    """
    ...
    def __iter__(self) -> "CsvWriterIterator":
        """Return self as iterator."""
        ...
